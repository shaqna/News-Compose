package com.ngedev.newsapplicationcompose.data.repository

import androidx.paging.*
import com.ngedev.newsapplicationcompose.data.source.local.LocalDataSource
import com.ngedev.newsapplicationcompose.data.source.local.entity.FavoriteEntity
import com.ngedev.newsapplicationcompose.data.source.remote.ArticleRemote
import com.ngedev.newsapplicationcompose.data.source.remote.RemoteMediator
                    ...
                    database.runAsTransaction {
                        ...
                        response.articles.forEach {
                            database.insertArticle(
                                it.copy(
                                    publishedAt = it.publishedAt?.toDate()?.formatTo("MMM dd, yyyy")
                                )
                            )
                        }
                    }
